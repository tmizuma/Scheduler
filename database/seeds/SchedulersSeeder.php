...
class SchedulersSeeder extends Seeder {
    ...
    public function run() {
        ...
        DB::table('schedulers')->insert([
            ...
            ['id' => 3, 'room_id' => 2, 'user_name' => '水馬','description' => '人事を担当', 'start_time' => '2018-01-23 21:00:00', 'end_time' => '2018-01-21 22:00:00'],
            ['id' => 4, 'room_id' => 2, 'user_name' => '田村','description' => '営業を担当', 'start_time' => '2018-01-23 21:00:00', 'end_time' => '2018-01-21 22:00:00']
        ]);
    }
}
